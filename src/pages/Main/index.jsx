                ...
                <div className="main__inner">
                    ...
                    <div className="main__content first">
                        <div className="main__item">
                            ...
                            <p className="main__item--text">Pass to private parties</p>
                        </div>
                        ...
                        <div className="main__item">
                            ...
                            <p className="main__item--text">Pass to airport bussiness lounges</p>
                        </div>
                        ...
                        <div className="main__item">
                            ...
                            <p className="main__item--text">Pass to concert of your fave celebs</p>
                        </div>
                    </div>
                    ...
                    <div className="main__grid">
                        <div className="main__grid--content horiz">
                            ...
                            <div className="main__grid--item">
                                ...
                                <p className="main__item--text">in cofes and restorantes</p>
                            </div>
                            ...
                            <div className="main__grid--item">
                                ...
                                <p className="main__item--text">in the banks</p>
                            </div>
                        </div>
                        ...
                        <div className="main__grid--content verti">
                            <div className="main__grid--item">
                                ...
                                <div className="main__grid--text--inner">
                                    <p className="main__grid--text--title">discount</p>

                                    <p className="main__grid--text--text">on physical items</p>
                                </div>
                            </div>
                            ...
                            <div className="main__grid--item">
                                ...
                                <div className="main__grid--text--inner">
                                    ...
                                    <p className="main__grid--text--text">on virtual items</p>
                                </div>
                            </div>
                            ...
                            <div className="main__grid--item">
                                ...
                                <div className="main__grid--text--inner">
                                    ...
                                    <p className="main__grid--text--text">on servies</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <p className="main__text">
                        Besides the NFT, you will receive a QR code that will give you a shortcut to
                    ...
                    <p className="main__text">
                        To get Brand NFT Certificate, you need to have one of the items of the
                    ...
                    <div className="main__square">
                        <div className="main__square--item">
                            <img
                                ...
                                alt="brand"
                                className="main__square--img"
                            />

                            <p className="main__square--text">Calvin Clein</p>
                        </div>
                        ...
                        <div className="main__square--item">
                            ...
                            <p className="main__square--text">Omega</p>
                        </div>
                        ...
                        <div className="main__square--item">
                            ...
                            <p className="main__square--text">Cwatch</p>
                        </div>

                        <div className="main__square--item">
                            <img
                                src="/assets/img/brand-logo4.png"
                                alt="brand"
                                className="main__square--img"
                            />

                            <p className="main__square--text">Jagermeister</p>
                        </div>

                        <div className="main__square--item">
                            <img
                                src="/assets/img/brand-logo5.png"
                                alt="brand"
                                className="main__square--img"
                            />

                            <p className="main__square--text">Balenciaga</p>
                        </div>

                        <div className="main__square--item">
                            <img
                                src="/assets/img/brand-logo6.png"
                                alt="brand"
                                className="main__square--img"
                            />

                            <p className="main__square--text">Hugo Boss</p>
                        </div>
                    </div>
                    ...
                    <div className="main__three">
                        <div className="main__three--content">
                            <p className="main__three--text">Choose a brand</p>
                        ...
                        <div className="main__three--content">
                            <p className="main__three--text">Connect your wallet</p>
                        ...
                        <div className="main__three--content">
                            <p className="main__three--text">Click the “Get on Whitelist” button</p>
                    ...
                    <p className="main__text">
                        Our next step <br />
                        You will receive the NFT as soon as you buy a branded item
                    </p>
                    ...
                    <div className="main__footer">
                        <div className="main__footer--content">
                            <div className="main__footer--logo--wrap">
                                <div className="main__footer--logo">Choose your brand now</div>
                            </div>
