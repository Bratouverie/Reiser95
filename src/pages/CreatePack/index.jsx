                ...
                <div className="createpage__inner">
                    ...
                    <div className="create__content">
                        <div className="create__item half">
                            ...
                            <input type="text" className="input create__item--input" placeholder="Enter Pack name" />
                        </div>
                        ...
                        <div className="create__item">
                            ...
                            <p className="create__item--text">
                                File types supported: JPG, PNG, GIF, SVG, Mp4, WEBM, MP3, WAV, OGG, GLB, GLTF. Max 1000 files. Files are sorted by file name.
                            </p>

                            <input id="createpackImgs" type="file" className="file" accept="image/png, image/gif, image/jpeg" />
                        ...
                        <div className="create__item">
                            ...
                            <p className="create__item--text">
                                Because you&rsquo;ve included multimedia, you&rsquo;ll need to provide an images (PNG, JPG, or GIF) for the card display of your item. Files are sorted by file name.
                            </p>

                            <input id="createpackPreview" type="file" className="file" accept="image/png, image/gif, image/jpeg" />
