...
const AlcoModal  = ({active, setActive}) => {
    return(
            ...
            <div className="modal__inner">
                <div className="modal__content">
                    ...
                    <div className="modal__content--bottom">
                        <p className="blue">
                            Jack Daniel&rsquo;s NFT Certificates
                        </p>
                        ...
                        <Input title="Enter name of the product" placeholder="e.g. Old nr 7 - Black Lable" />
                        ...
                        <Input title="Place of purchase (shop adress: country, city, street, office)" placeholder="e.g. 1950 Cascade Hollow Rd, Tullahoma, TN 37388, USA" />
                        ...
                        <Input textarea title="Describe story of the bottle" placeholder="e.g. I had a friend that I had not seen for 5 years come to visit me. To celebrate I got a bottle of Jack, which I had been saving for a special occasion. We drank and my friend told me many interesting stories that had happened to him. It was a wonderful memory..." />
                        ...
                        <div className="modal__buttons">
                            ...
                            <button className="button button__default half delete">
                                Delete
                            </button>
                        </div>
