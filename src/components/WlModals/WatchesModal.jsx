...
const WatchesModal  = ({active, setActive}) => {
    return(
            ...
            <div className="modal__inner">
                <div className="modal__content">
                    ...
                    <div className="modal__content--bottom">
                        ...
                        <Input title="Enter your product's model name" placeholder="e.g. Speedmaster Professional Moonwatch" />
                        ...
                        <Input title="Place of purchase (shop adress: country, city, street, office)" placeholder="e.g. Reed's Jewelers, 926 Inspiration Dr, Wilmington, 28405, USA" />
                        ...
                        <Input textarea title="Describe story about your watch" placeholder="e.g. I had a memorable victory at the Crans-sur-Sierre Golf Club in Switzerland. I received an OMEGA watch as my prize. A very nice watch!" />
